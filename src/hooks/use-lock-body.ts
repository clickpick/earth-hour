...
export default function useLockBody(locked: boolean = true, elementRef?: RefObject<HTMLElement>) {
    let element: RefObject<HTMLElement> = useRef<HTMLElement>(document.body);
